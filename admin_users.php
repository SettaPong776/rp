    ...
    <div class="card-header bg-white py-3">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <select class="form-select form-select-sm" id="roleFilterSelect" onchange="filterRole(this.value)" style="min-width:180px;">
                    <option value="">ทั้งหมด</option>
                    <option value="ผู้ดูแลระบบ">ผู้ดูแลระบบ</option>
                    <optgroup label="── หัวหน้างาน ──">
                        <option value="หัวหน้างานอาคาร">หัวหน้างานอาคาร</option>
                        <option value="หัวหน้างานไฟฟ้า">หัวหน้างานไฟฟ้า</option>
                        <option value="หัวหน้างานประปาฯ">หัวหน้างานประปาฯ</option>
                        <option value="หัวหน้างานปรับอากาศ">หัวหน้างานปรับอากาศ</option>
                    </optgroup>
                    <optgroup label="── เจ้าหน้าที่ ──">
                        <option value="งานอาคาร">งานอาคาร</option>
                    ...
                    <?php while ($user = mysqli_fetch_assoc($users)): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif ($user['role'] == 'head_building'): ?>
                                    <span class="badge text-white" style="background:#b45309;">หัวหน้างานอาคาร</span>
                                <?php elseif ($user['role'] == 'head_electrical'): ?>
                                    <span class="badge text-white" style="background:#1d4ed8;">หัวหน้างานไฟฟ้า</span>
                                <?php elseif ($user['role'] == 'head_plumbing'): ?>
                                ...
                                <div class="btn-group">
                                    <?php if ($_SESSION['role'] == 'admin'): ?>
                                        ...
                                        <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                            data-bs-target="#resetPasswordModal" data-user-id="<?php echo $user['user_id']; ?>"
                                            data-username="<?php echo $user['username']; ?>">
                                            <i class="bx bx-key"></i>
                                        </button>
                                        <?php if ($user['user_id'] != $_SESSION['user_id']): ?>
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteUserModal" data-user-id="<?php echo $user['user_id']; ?>"
                                                data-username="<?php echo $user['username']; ?>">
                                                <i class="bx bx-trash"></i>
                                            </button>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="text-muted"><small>ไม่มีสิทธิ์จัดการ</small></span>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select" id="role" name="role" required>
                                    ...
                                    <optgroup label="--- หัวหน้างาน ---">
                                        ...
                                        <option value="head_electrical">หัวหน้างานไฟฟ้า</option>
                                        <option value="head_plumbing">หัวหน้างานประปาและระบบสุขาภิบาล</option>
                                        <option value="head_ac">หัวหน้างานระบบปรับอากาศ</option>
                                    </optgroup>
                                    <optgroup label="--- เจ้าหน้าที่ ---">
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="edit_fullname" class="form-label">ชื่อ-นามสกุล <span
                                    class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text bg-light">
                                    <i class="bx bx-id-card"></i>
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        <i class="bx bx-info-circle me-1"></i>การรีเซ็ตรหัสผ่านจะมีผลทันที
                        และผู้ใช้ต้องใช้รหัสผ่านใหม่ในการเข้าสู่ระบบครั้งต่อไป
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ยกเลิก</button>
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger">
                        <i class="bx bx-error-circle me-1"></i>การลบผู้ใช้จะลบข้อมูลทั้งหมดที่เกี่ยวข้องกับผู้ใช้นี้
                        รวมถึงรายการแจ้งซ่อมทั้งหมด การดำเนินการนี้ไม่สามารถย้อนกลับได้
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">ยกเลิก</button>
...
<script>
    ...
    function filterRole(role) {
        // sync dropdown ให้ตรงกับค่าที่เลือก
        var sel = document.getElementById('roleFilterSelect');
